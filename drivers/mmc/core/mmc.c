...
{										
    ...
    if(si.totalram > 1572864 )				   
   		strcpy(ramsize , "8G");
    else if(si.totalram > 1048576)			  
    		strcpy(ramsize , "6G");
    else if(si.totalram > 786432)			 
    		strcpy(ramsize , "4G");
    else if(si.totalram > 524288)			
    		strcpy(ramsize , "3G");
    else if(si.totalram > 262144)               
    		strcpy(ramsize , "2G");
    else
    		strcpy(ramsize , "1G");
    ...
    if(emmc_capacity > 67108864)  		
		strcpy(romsize , "64G");
    else if(emmc_capacity > 33554432)  
		strcpy(romsize , "32G");
    else if(emmc_capacity > 16777216)  
		strcpy(romsize , "16G");
    else if(emmc_capacity > 8388608)  
		strcpy(romsize , "8G");
    else
		strcpy(romsize , "4G");	
    ...
    if(strnicmp((const char *)tempID, "90014A", 6) == 0)           
   		strcpy(vendorName , "Hynix");
    else if(strnicmp((const char *)tempID, "150100", 6) == 0)		
   		strcpy(vendorName , "Samsung");
    else if(strnicmp((const char *)tempID, "450100", 6) == 0)		
